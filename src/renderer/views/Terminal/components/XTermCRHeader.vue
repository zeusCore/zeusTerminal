<template>
    <section class="xterm-header cr-header" flex="mian:justify box:mean">
        <div class="left">
        ...
        <div class="right" flex="main:right ">
            <div
                class="term-btn"
                @click="handleAction('close-connection', term.id, term.cnnid)"
            >
                <i style="font-size: 16px;" class="icon icon-remove"></i>
            </div>
        </div>
    </section>
</template>
